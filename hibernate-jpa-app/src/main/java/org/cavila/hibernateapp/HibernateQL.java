...
import org.cavila.hibernateapp.dominio.ClienteDto;
...
public class HibernateQL {
    public static void main(String[] args) {
        ...
        System.out.println("\n");
        List<ClienteDto> clientesDto = em.createQuery("select new org.cavila.hibernateapp.dominio.ClienteDto(c.nombre, c.apellido) from Cliente c", ClienteDto.class)
                .getResultList();
