package org.cavila.junit5app.ejemplos.models;

import org.cavila.junit5app.ejemplos.exceptions.DineroInsuficienteException;
...
class CuentaTest {
    ...
    void initMetodoTest(TestInfo testInfo, TestReporter testReporter) {
        this.cuenta = new Cuenta("CECILIO", new BigDecimal("1000.12345"));
...
//        assertNotEquals(cuenta2, cuenta);
    ...
    class CuentaOperacionesTest{
        ...
        void testTransferirDineroCuentas() {
            ...
            Cuenta cuenta2 = new Cuenta("CECILIO", new BigDecimal("1500.8989"));
    ...
    void testRelacionBancoCuentas() {
        ...
        assertAll(() -> assertEquals("1000.8989", cuenta2.getSaldo().toPlainString(),
                ...
                () -> assertEquals("CECILIO", banco.getCuentas().stream()
                        .filter(c -> c.getPersona().equals("CECILIO"))
                        .findFirst()
                        .get().getPersona()),
    ...
    class SistemPropertiesTest{
        ...
        @Test
        @EnabledIfSystemProperty(named = "user.name", matches = "cavila")
        void testUsername() {
        }
